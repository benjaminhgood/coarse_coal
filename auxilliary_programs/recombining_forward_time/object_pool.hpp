...
class SharedObjectPool{
    ...
    public:
        ...
        SharedObjectPool(int capacity = 1, T const & prototype_object = T()): capacity(capacity), object_records(capacity, ObjectRecord{prototype_object,0}), free_list(capacity,0) {
